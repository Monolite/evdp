...
class GuiHandler():
    ...
    def paint_foreground(self):
        ...
        #carga de la pila
        self.cr.set_source(gradient)
        self.cr.move_to(self.width - 40, 27)        
        self.cr.line_to(self.width - 43, 27)
        self.cr.line_to(self.width - 43, 13)
        self.cr.line_to(self.width - 40, 13)
        self.cr.close_path()
        #self.cr.fill()
    ...
    def __init__(self):
        ...
        self.func3 = "func3"
        self.scale = 3
        self.width = 160 * self.scale
        self.height = 128 * self.scale
        self.padding = 2
        self.top_margin = 75;
